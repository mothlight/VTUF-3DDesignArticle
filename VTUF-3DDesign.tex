...
\begin{figure}[!htbp]
   ...
   %\fbox{
   \includegraphics[trim=110mm 211mm 621mm 210mm, clip, scale=0.15]{images/VTUF-Design-3.png}\label{fig:initray}
   %}
   }
  \hspace{0.5cm}  
   \subfloat[TUF-3D unmodified shading.]{
   %\fbox{
   \includegraphics[trim=110mm 211mm 621mm 210mm, clip, scale=0.15]{images/VTUF-Design-2.png}\label{fig:shading}
   %}
   }
  \hspace{0.5cm}
  \\
   ...
   %\fbox{
   \includegraphics[trim=110mm 211mm 621mm 210mm, clip, scale=0.15]{images/VTUF-Design-4.png}\label{fig:modshading}
   %}
   }
  \hspace{0.5cm}
   \subfloat[VTUF-3D reverse ray tracing.]{
   %\fbox{
   \includegraphics[trim=110mm 211mm 621mm 210mm, clip, scale=0.15]{images/VTUF-Design-5.png}\label{fig:modshadingreverse}
   %}
   }
...
\begin{center}
\begin{table}[!htbp]
\caption{RMSE (W m$^{-2}$) VTUF-3D vs. Intercomparison results \citep{Best2012} comparison for Preston evaluation scenarios for 10 February-10 March 2004.\label{fig:prestonrmse}} 
...
\begin{center}
\begin{table}[!htbp]
\caption{MBE (W m$^{-2}$) VTUF-3D vs. Intercomparison results \citep{Best2012} comparison for Preston evaluation scenarios for 10 February-10 March 2004.\label{fig:prestonmbe}} 
\begin{tabular}{  | l | l | l|l|l| } 
\hline \textbf{Scenario name} &\textbf{$Q^{*}$}& \textbf{$Q_{H}$}& \textbf{$Q_{G}$}& \textbf{$Q_{E}$}  \\ \hline
Pr04Val & 3.0&	-4.0&	-8.3&	-9.5    \\ \hline
Pr04NoVeg & 41.1&	-6.3&	11.0&	23.8  \\ \hline	
IntercomparisonNoVeg & 2&	45&	-16& -32   \\ \hline
IntercomparisonTiled & -7&	13&	-22& -1  \\ \hline
IntercomparisonIntegrated & -5&	13&	-18& -3   \\ \hline
  \end{tabular} 
\end{table}
\end{center} 
